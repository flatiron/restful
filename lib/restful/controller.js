...
controller.create = function (req, res, resource, optionsRef, respond) {
  ...
  if (options.parent) {
    ...
    if(typeof req.body[parentField] === 'undefined' && typeof options._id === 'undefined') {
      status = 500;
      return respond(req, res, status, new Error(parentField + ' is required.'));
    }
