  ...
  resources.forEach(function (resource) {
    ...
    router.path(entity, function () {
      ...
      this.get(function () {
        ...
        // TODO: Check if the parent exists before getting its children.
        var getter;
        if (options.parent) {
          options.parentID = exports.buildResourceId(routeInfoRef, arguments);
          getter = resource['by' + options.parent.resource].bind(resource, options.parentID);
        } else {
          getter = resource.all.bind(resource);
        }

        getter(function (err, results) {
          if (!options.strict) {
