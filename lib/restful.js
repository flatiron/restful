...
function _extendWithRoutes (router, resource) {
  ...
  //
  if(!Array.isArray(self.disable) || ~self.disable.indexOf('all')) {
  ...
  if(!Array.isArray(self.disable) || ~self.disable.indexOf('create')) {
    //
  ...
  router.path('/' + pluralEntity + '/:id', function(){
    ...
    if(!Array.isArray(self.disable) || ~self.disable.indexOf('get')) {
      //
    ...
    if(!Array.isArray(self.disable) || ~self.disable.indexOf('destroy')) {
      //
    ...
    if(!Array.isArray(self.disable) || ~self.disable.indexOf('update')) {
      //
