...
function _extendWithNonStrictRoutes(router, resource) {
  ...
  */
  ...
  if(!Array.isArray(router.disable) || !~router.disable.indexOf('update')) {
    //
  ...
  if(!Array.isArray(router.disable) || !~router.disable.indexOf('destroy')) {
    //
...
function _extendWithRoutes (router, resource) {
  ...
  if(!Array.isArray(router.disable) || !~router.disable.indexOf('all')) {
    //
  ...
  if(!Array.isArray(router.disable) || !~router.disable.indexOf('create')) {
    //
  ...
  router.path('/' + pluralEntity + '/:id', function(){
    ...
    if(!Array.isArray(router.disable) || !~router.disable.indexOf('get')) {
      //
