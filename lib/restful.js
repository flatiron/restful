...
//
// ### function createServer (resources, options)
// #### @resources {resourceful.Resource} Resource(s) to use for the router.
// #### @handler {Function} http request handler
//
exports.createServer = function (resources, handler) {
  var router = exports.createRouter(resources);
