...
//
exports.extendRouter = function (router, resource, options, respond) {
  options = options || {};
...
function preprocessRequest (req, resource) {
  //
  // Remark: Since `restful` generates is a REST interface for a Resource,
  // which inheritently has more functionality then HTTP can provide out of the box,
  ...
  //
  // Attempt to coherse any incoming properties know to be bumbers to a Number
  //
